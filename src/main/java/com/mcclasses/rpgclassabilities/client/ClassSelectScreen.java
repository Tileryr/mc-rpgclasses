...
public class ClassSelectScreen extends Screen {
    protected ClassSelectScreen(Text title) {
        super(title);
    }
    public static final Identifier classIconsTexture = Identifier.of("rpgclassabilities", "textures/class/class_icons.png");
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        drawTextureCentered(context, classIconsTexture, u, v, width, height);
        // Rogue
